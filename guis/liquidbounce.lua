...
local getcustomassets = {
	['cat67/assets/liquidbounce/blatant.png'] = 'rbxasset://liquidbounce/blatant.png',
	['cat67/assets/liquidbounce/combat.png'] = 'rbxasset://liquidbounce/combat.png',
	['cat67/assets/liquidbounce/expand.png'] = 'rbxasset://liquidbounce/expand.png',
	['cat67/assets/liquidbounce/inventory.png'] = 'rbxasset://liquidbounce/inventory.png',
	['cat67/assets/liquidbounce/logo.png'] = 'rbxasset://liquidbounce/logo.png',
	['cat67/assets/liquidbounce/minigames.png'] = 'rbxasset://liquidbounce/minigames.png',
	['cat67/assets/liquidbounce/render.png'] = 'rbxasset://liquidbounce/render.png',
	['cat67/assets/liquidbounce/textgui.png'] = 'rbxasset://liquidbounce/textgui.png',
	['cat67/assets/liquidbounce/utility.png'] = 'rbxasset://liquidbounce/utility.png',
	['cat67/assets/liquidbounce/world.png'] = 'rbxasset://liquidbounce/world.png',
...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/amack7002-codedede/CatV6/'..readfile('cat67/profiles/commit.txt')..'/'..select(1, path:gsub('cat67/', '')), true)
		end)
...
local function writeFont()
	...
	--[[writefile('cat67/assets/liquidbounce/lbfont.json', httpService:JSONEncode({
		name = 'Inter',
		faces = {
			{style = 'normal', assetId = getcustomasset('cat67/assets/liquidbounce/Inter-Light.ttf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('cat67/assets/liquidbounce/Inter-Regular.ttf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('cat67/assets/liquidbounce/Inter-Medium.ttf'), name = 'Medium', weight = 500}
		}
	}))]]
	return getcustomasset('cat67/assets/liquidbounce/lbfont.json')
end
...
components = {
	...
	ColorSlider = function(optionsettings, children, api)
		...
		rainbow3.Image = getcustomasset('cat67assets/new/rainbow_3.png')
	...
	Dropdown = function(optionsettings, children, api)
		...
		dropdownexpand.Image = getcustomasset('cat67assets/liquidbounce/expand.png')
	...
	Targets = function(optionsettings, children, api)
		...
		icon.Image = getcustomasset('cat67assets/new/targetstab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		...
		optionapi.Players = components.TargetsButton({
			...
			Icon = getcustomasset('cat67assets/new/targetplayers1.png'),
		...
		optionapi.NPCs = components.TargetsButton({
			...
			Icon = getcustomasset('cat67assets/new/targetnpc1.png'),
			IconSize = UDim2.fromOffset(12, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('cat67assets/new/targetnpc2.png'),
	...
	TextList = function(optionsettings, children, api)
		...
		buttonicon.Image = optionsettings.Icon or getcustomasset('cat67/assets/new/allowedicon.png')
		...
		icon.BackgroundTransparency = 1
		icon.Image = optionsettings.Tab or getcustomasset('cat67/assets/new/allowedtab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		title.Size = UDim2.new(1, -36, 0, 20)
		...
		addbutton.Image = getcustomasset('cat67/assets/new/add.png')
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		expandicon.Image = getcustomasset('cat67/assets/liquidbounce/expand.png')
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('cat67assets/liquidbounce/combat.png'),
	Size = UDim2.fromOffset(16, 15)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('cat67/assets/liquidbounce/blatant.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('cat67ssets/liquidbounce/render.png'),
	Size = UDim2.fromOffset(15, 9)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('cat67assets/liquidbounce/utility.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('cat67/assets/liquidbounce/world.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('cat67/assets/liquidbounce/inventory.png'),
	Size = UDim2.fromOffset(14, 15)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('cat67/assets/liquidbounce/minigames.png'),
	Size = UDim2.fromOffset(15, 15)
})
