...
local getcustomassets = {
	['catnext/assets/liquidbounce/blatant.png'] = 'rbxasset://liquidbounce/blatant.png',
	['catnext/assets/liquidbounce/combat.png'] = 'rbxasset://liquidbounce/combat.png',
	['catnext/assets/liquidbounce/expand.png'] = 'rbxasset://liquidbounce/expand.png',
	['catnext/assets/liquidbounce/inventory.png'] = 'rbxasset://liquidbounce/inventory.png',
	['catnext/assets/liquidbounce/logo.png'] = 'rbxasset://liquidbounce/logo.png',
	['catnext/assets/liquidbounce/minigames.png'] = 'rbxasset://liquidbounce/minigames.png',
	['catnext/assets/liquidbounce/render.png'] = 'rbxasset://liquidbounce/render.png',
	['catnext/assets/liquidbounce/textgui.png'] = 'rbxasset://liquidbounce/textgui.png',
	['catnext/assets/liquidbounce/utility.png'] = 'rbxasset://liquidbounce/utility.png',
	['catnext/assets/liquidbounce/world.png'] = 'rbxasset://liquidbounce/world.png',
...
local function writeFont()
	...
	--[[writefile('catnext/assets/liquidbounce/lbfont.json', httpService:JSONEncode({
		name = 'Inter',
		faces = {
			{style = 'normal', assetId = getcustomasset('catnext/assets/liquidbounce/Inter-Light.ttf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('catnext/assets/liquidbounce/Inter-Regular.ttf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('catnext/assets/liquidbounce/Inter-Medium.ttf'), name = 'Medium', weight = 500}
		}
	}))]]
	return getcustomasset('catnext/assets/liquidbounce/lbfont.json')
end
...
do
	...
	local res = isfile('catnext/profiles/color.txt') and loadJson('catnext/profiles/color.txt')
	if res then
...
components = {
	...
	ColorSlider = function(optionsettings, children, api)
		...
		preview.Image = getcustomasset('catnext/assets/new/colorpreview.png')
		...
		expand.Image = getcustomasset('catnext/assets/new/expandicon.png')
		...
		rainbow1.Image = getcustomasset('catnext/assets/new/rainbow_1.png')
		rainbow1.ImageColor3 = color.Light(uipallet.Main, 0.37)
		rainbow1.Parent = rainbow
		local rainbow2 = rainbow1:Clone()
		rainbow2.Image = getcustomasset('catnext/assets/new/rainbow_2.png')
		rainbow2.Parent = rainbow
		local rainbow3 = rainbow1:Clone()
		rainbow3.Image = getcustomasset('catnext/assets/new/rainbow_3.png')
		rainbow3.Parent = rainbow
		local rainbow4 = rainbow1:Clone()
		rainbow4.Image = getcustomasset('catnext/assets/new/rainbow_4.png')
	...
	Dropdown = function(optionsettings, children, api)
		...
		dropdownexpand.Image = getcustomasset('catnext/assets/liquidbounce/expand.png')
	...
	Targets = function(optionsettings, children, api)
		...
		icon.Image = getcustomasset('catnext/assets/new/targetstab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		...
		optionapi.Players = components.TargetsButton({
			...
			Icon = getcustomasset('catnext/assets/new/targetplayers1.png'),
			IconSize = UDim2.fromOffset(15, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('catnext/assets/new/targetplayers2.png'),
		...
		optionapi.NPCs = components.TargetsButton({
			...
			Icon = getcustomasset('catnext/assets/new/targetnpc1.png'),
			IconSize = UDim2.fromOffset(12, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('catnext/assets/new/targetnpc2.png'),
	...
	TextList = function(optionsettings, children, api)
		...
		buttonicon.Image = optionsettings.Icon or getcustomasset('catnext/assets/new/allowedicon.png')
		...
		icon.BackgroundTransparency = 1
		icon.Image = optionsettings.Tab or getcustomasset('catnext/assets/new/allowedtab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		title.Size = UDim2.new(1, -36, 0, 20)
		...
		addbutton.Image = getcustomasset('catnext/assets/new/add.png')
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		expandicon.Image = getcustomasset('catnext/assets/liquidbounce/expand.png')
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('catnext/assets/liquidbounce/combat.png'),
	Size = UDim2.fromOffset(16, 15)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('catnext/assets/liquidbounce/blatant.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('catnext/assets/liquidbounce/render.png'),
	Size = UDim2.fromOffset(15, 9)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('catnext/assets/liquidbounce/utility.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('catnext/assets/liquidbounce/world.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('catnext/assets/liquidbounce/inventory.png'),
	Size = UDim2.fromOffset(14, 15)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('catnext/assets/liquidbounce/minigames.png'),
	Size = UDim2.fromOffset(15, 15)
})
