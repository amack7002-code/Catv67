...
local getcustomasset = vape.Libraries.getcustomasset
	local drawingactor = loadstring(downloadFile('catnextwrite/libraries/drawing.lua'), 'drawing')(...)
...
if not select(1, ...) and game.PlaceId == 5938036553 then
	if run_on_actor and getactors then
		...
		task.spawn(function()
			...
			local executionString = "loadfile('catnextwrite/main.lua')(" .. drawingactor .. ')'
