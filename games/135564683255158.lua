...
if isfile('catnext/games/'..vape.Place..'.lua') then
	loadstring(readfile('catnext/games/'..vape.Place..'.lua'), 'prison life')()
else
	if not shared.VapeDeveloper then
		...
		if suc and res ~= '404: Not Found' then
			loadstring(downloadFile('catnext/games/'..vape.Place..'.lua'), 'prison life')()
		end
	end
end