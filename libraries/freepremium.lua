...
local license = ... or {}
local REPO = "https://raw.githubusercontent.com/amack7002-code/CatV6/main/"
...
local function ensureCacheTree()
    ensureFolder("cat67")
    ensureFolder("cat67/profiles")
    ensureFolder("cat67/assets")
    ensureFolder("cat67/assets/new")
    ensureFolder("cat67/games")
    ensureFolder("cat67/guis")
    ensureFolder("cat67libraries")
    local commit = "cat67profiles/commit.txt"
